...
export interface BudgetContextType {
  ...
  addBudgetItem: (name: string, amount: number, isImpulse?: boolean, isContinuous?: boolean, isRecurring?: boolean, note?: string, tag?: string | null) => Promise<void>;
  updateBudgetItem: (id: string, updates: Partial<BudgetItem>) => Promise<void>;
  deleteBudgetItem: (id: string) => Promise<void>;
  addSubItem: (budgetItemId: string, name: string, amount: number, note?: string, tag?: string | null) => Promise<SubBudgetItem>;
  ...
  initializeBudget: (budgetPeriod: BudgetPeriod, amount: number) => Promise<void>;
